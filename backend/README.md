...
- **`routes/api.py`**: Exposes REST interfaces (`/analyze-transactions`, `/subscriptions`, `/cancel-subscription`). Handles Twilio credentials to dispatch a live SMS to the verified mobile number immediately upon cancellation.
